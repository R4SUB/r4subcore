...
#> ℹ Run context created: "R4S-20260716044939-wl4dieex"
print(ctx)
#> <r4sub_run_context>
#>   run_id:       R4S-20260716044939-wl4dieex 
#>   study_id:     STUDY001 
#>   environment:  DEV 
#>   user:         runner 
#>   created_at:   2026-07-16 04:49:39
```
...
#> 1 R4S-20260716044939-wl4dieex STUDY001   P21-SD0001   fail     high
```
